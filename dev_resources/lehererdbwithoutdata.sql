...
MySQL - 5.7.21-log : Database - lehererdbcopy
*********************************************************************
*/
...
/*Table structure for table `dummyschool` */

DROP TABLE IF EXISTS `dummyschool`;

CREATE TABLE `dummyschool` (
  `Id` int(11) NOT NULL AUTO_INCREMENT,
  `schooltype` varchar(255) DEFAULT NULL,
  `tnid` varchar(255) DEFAULT NULL,
  PRIMARY KEY (`Id`)
) ENGINE=InnoDB AUTO_INCREMENT=10485 DEFAULT CHARSET=utf8mb4;
...
CREATE TABLE `institutions` (
  ...
  `originaluserid` varchar(10) DEFAULT NULL,
  PRIMARY KEY (`institutionid`)
) ENGINE=InnoDB AUTO_INCREMENT=32657 DEFAULT CHARSET=utf8mb4;
...
/*Table structure for table `order_training_user` */

DROP TABLE IF EXISTS `order_training_user`;

CREATE TABLE `order_training_user` (
  `orderid` int(11) DEFAULT NULL,
  `userid` int(11) DEFAULT NULL,
  `trainingid` int(11) DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;

/*Table structure for table `order_training_user_lookup` */

DROP TABLE IF EXISTS `order_training_user_lookup`;

CREATE TABLE `order_training_user_lookup` (
  `orderid` varchar(11) NOT NULL DEFAULT '0',
  `userid` varchar(255) DEFAULT NULL,
  `trainingid` varchar(255) DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
CREATE TABLE `orders` (
  ...
  `numberofclasses` varchar(20) DEFAULT NULL,
...
) ENGINE=InnoDB AUTO_INCREMENT=22775 DEFAULT CHARSET=utf8mb4;
...
CREATE TABLE `schooltype` (
  ...
  `schooltype` varchar(150) DEFAULT NULL,
  `description` varchar(90) DEFAULT NULL,
  PRIMARY KEY (`schooltype_id`)
) ENGINE=InnoDB AUTO_INCREMENT=10318 DEFAULT CHARSET=utf8mb4;
...
CREATE TABLE `schooltype_institutions` (
  ...
  KEY `schooltypeKey_idx` (`schooltype_id`),
  KEY `institutionKey` (`institutionid`),
  ...
  CONSTRAINT `schooltypeKey` FOREIGN KEY (`schooltype_id`) REFERENCES `schooltype` (`schooltype_id`) ON DELETE NO ACTION ON UPDATE NO ACTION
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
DROP TABLE IF EXISTS `training_institutions`;
...
CREATE TABLE `trainings` (
  ...
  `originalid` varchar(10) DEFAULT NULL,
  `mfcaccompaniment` varchar(45) DEFAULT NULL,
...
) ENGINE=InnoDB AUTO_INCREMENT=29162 DEFAULT CHARSET=utf8mb4;
