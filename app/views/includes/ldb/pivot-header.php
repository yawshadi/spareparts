...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="<?php echo URLROOT ?>/vendor/nicolaskruchten/pivottable/dist/pivot.css"/>
    ...
    <script type="text/javascript" src="<?php echo URLROOT ?>/vendor/nicolaskruchten/pivottable/dist/pivot.js"></script>
    ...
    <script type="text/javascript" src="<?php echo URLROOT ?>/vendor/nicolaskruchten/pivottable/dist/c3_renderers.js"></script>
    ...
    <script type="text/javascript" src="<?php echo URLROOT ?>/ldb/js/data/tips_data.min.js"></script>
