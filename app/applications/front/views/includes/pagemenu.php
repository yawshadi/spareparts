                        ...
                        <div class="col-xl-9 col-lg-9 col-md-12 ">
                            <nav class="d-none d-lg-block">
                                <ul class="header-bottom-list d-flex">
                                    <li class=""><a href="<?php echo URLROOT.'/front/pages/home'?>">home</a>
                                        <!-- Home Version Dropdown Start -->
                                        
                                        <!-- Home Version Dropdown End -->
                                    </li>
                                    <li><a href="<?php echo URLROOT.'/front/pages/terms'?>">Terms and conditions</a></li>
                                    <li><a href="<?php echo URLROOT.'/front/pages/shop'?>">shop</a>
                                        <!-- Home Version Dropdown Start -->
                                     
                                        <!-- Home Version Dropdown End -->
                                    </li>
                                  
                                    <li><a href="<?php echo URLROOT.'/front/pages/contact'?>">Contact us</a>
                                        <!-- Home Version Dropdown Start -->
                                    
                                        <!-- Home Version Dropdown End -->
                                    </li>
                                    <li class=""><a href="<?php echo URLROOT.'/front/pages/about'?>">About Us</a></li>
                                </ul>
                            </nav>
                            <div class="mobile-menu d-block d-lg-none">
                                <nav>
                                    <ul>
                                    <li class=""><a href="<?php echo URLROOT.'/front/pages/home'?>">Home</a></li>
                                    <li class=""><a href="<?php echo URLROOT.'/front/pages/shop'?>">Shop</a></li>
                                    <li class=""><a href="<?php echo URLROOT.'/front/pages/contact'?>">Contact</a></li>
                                      
                                    <li class=""><a href="<?php echo URLROOT.'/front/pages/about'?>">About Us</a></li>
                                    <li class=""><a href="<?php echo URLROOT.'/front/pages/terms'?>">Terms</a></li>
                                    </ul>
                                </nav>
                            </div>
                        </div>
