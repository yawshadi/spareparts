 ...
 * a postcontroller for use with summernote so as to not strip of html tags
 */
class SummernoteController extends BaseController {

    public $controllertype = "SummernoteController";
    ...
    public function __construct() {
        foreach($_POST as $key => $value){
            if(is_string($value)){
                $_POST[$key] = filter_var($value,FILTER_DEFAULT);
            }
        }
    }
